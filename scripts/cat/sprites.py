...
class Sprites:
    ...
    def load_all(self):
        ...
        for x in os.listdir("sprites/verdinmod/borders"):
            self.spritesheet("sprites/verdinmod/borders/"+x, 'verdinmod/'+x.replace('.png', ""))
        for x in os.listdir("sprites/verdinmod/Base Colours"):
            self.spritesheet("sprites/verdinmod/Base Colours/"+x, 'base/'+x.replace('.png', ""))
        for x in os.listdir("sprites/verdinmod/points"):
            self.spritesheet("sprites/verdinmod/points/"+x, x.replace('.png', ""))
        for x in os.listdir("sprites/verdinmod/New Tabbies"):
            self.spritesheet("sprites/verdinmod/New Tabbies/"+x, 'Tabby/'+x.replace('.png', ""))
        for x in os.listdir("sprites/verdinmod/extra"):
            self.spritesheet("sprites/verdinmod/extra/"+x, 'Other/'+x.replace('.png', ""))
        for x in os.listdir("sprites/verdinmod/effects"):
            self.spritesheet("sprites/verdinmod/effects/"+x, 'Other/'+x.replace('.png', ""))
        for x in os.listdir("sprites/verdinmod/somatic"):
            self.spritesheet("sprites/verdinmod/somatic/"+x, 'Somatic/'+x.replace('.png', ""))
            self.make_group('Somatic/'+x.replace('.png', ""), (0, 0), "Somatic/"+x.replace('.png', ""))
        
        
        for x in os.listdir("sprites/verdinmod/white"):
            self.spritesheet("sprites/verdinmod/white/"+x, 'White/'+x.replace('.png', ""))
            self.make_group('White/'+x.replace('.png', ""), (0, 0), x.replace('.png', ""))
        for x in os.listdir("sprites/verdinmod/break white"):
            self.spritesheet("sprites/verdinmod/break white/"+x, 'Break/'+x.replace('.png', ""))
            self.make_group('Break/'+x.replace('.png', ""), (0, 0), 'break/'+x.replace('.png', ""))

        # ...idk what to call these
        self.make_group('verdinmod/fourears', (0, 0), 'fourears')

        self.make_group('verdinmod/normal border', (0, 0), 'normbord')
        self.make_group('verdinmod/foldborder', (0, 0), 'foldbord')
        self.make_group('verdinmod/curlborder', (0, 0), 'curlbord')

        self.make_group('verdinmod/foldlineart', (0, 0), 'foldlines')
        self.make_group('verdinmod/fold_curllineart', (0, 0), 'fold_curllines')
        self.make_group('verdinmod/curllineart', (0, 0), 'curllines')

        self.make_group('verdinmod/isolateears', (0, 0), 'isolateears')
        self.make_group('verdinmod/noears', (0, 0), 'noears')
        
        self.make_group('verdinmod/rexlines', (0, 0), 'rexlineart')
        self.make_group('verdinmod/rexlinesdead', (0, 0), 'rexlineartdead')
        self.make_group('verdinmod/rexlinesdf', (0, 0), 'rexlineartdf')
        self.make_group('verdinmod/rexborder', (0, 0), 'rexbord')

        for a, x in enumerate(range(1, 6)):
            self.make_group('verdinmod/bobtails', (a, 0), f'bobtail{x}')

        # verdinmod base colours
