...
| "medicine cat cats"             | Total number of medicine cats and medicine cat apprentices combined |
...
| "medicine cat" | Stat cat must be a medicine cat or medicine cat apprentice. Note that this doesn't override default behavior, only adds an additional requirement. |
